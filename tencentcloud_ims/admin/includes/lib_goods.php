 ...
 * @return bool
 */
function is_ims_enable()
{
    $ims_options = get_ims_options();
    return !empty($ims_options) && $ims_options['switch'] === '1';
}
...
function get_ims_options()
{
    return isset($GLOBALS['_CFG']['ims_plugin']) ? json_decode($GLOBALS['_CFG']['ims_plugin'], true) : array();
}
